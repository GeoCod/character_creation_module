...
def attack(char_name: str, char_class: str) -> str:
    """Определяет значение атаки в зависимости от персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет значение блокировки урона в зависимости от персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определяет значение спец атаки в зависимости от персонажа."""
    if char_class == 'warrior':
